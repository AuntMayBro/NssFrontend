...
const Navbar = () => {
  ...
  // Hide navbar on developers page
  if (location.pathname && location.pathname.startsWith("/developers"))
    return null;
    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div
            className="w-10 h-7 md:w-12 md:h-8 flex flex-col shadow-sm border border-gray-200"
            title="Indian Flag"
          >
          ...
          {navLinks.map((link) => (
            <a
              ...
              className={cn(
                ...
                scrolled
                  ? "text-nss-navy hover:text-nss-red"
                  : "text-nss-navy hover:text-nss-red", // Ensure visibility in light theme
              )}
            >
              {link.name}
            </a>
