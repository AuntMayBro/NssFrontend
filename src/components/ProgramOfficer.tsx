    ...
    return (
        <section className="relative py-12 md:py-24 bg-white overflow-hidden">
            <div className="container relative z-10 px-4 md:px-8">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20 max-w-7xl mx-auto">

                    {/* Image Section - Clean & Geometric */}
                    <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                        <div className="relative w-full max-w-[320px] md:max-w-none md:w-auto">
                            {/* Offset Border */}
                            <div className="absolute top-3 left-3 md:top-4 md:left-4 w-full h-full border-2 border-nss-navy/20 rounded-2xl z-0"></div>

                            {/* Main Image */}
                            <div className="relative w-full h-[400px] md:w-[380px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl z-10 bg-gray-100">
                                {officer.image ? (
                                    <img
                                        src={officer.image}
                                        alt={officer.name}
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6 md:p-8 text-white">
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-bold font-heading leading-tight">{officer.name}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 md:pl-10 text-center md:text-left text-nss-navy">
                        <h2 className="text-3xl md:text-5xl font-bold font-heading mb-6 md:mb-8 relative inline-block">
                            Leader. Mentor. <br />
                            <span className="text-nss-blue">Visionary.</span>
                            <span className="absolute -bottom-2 left-0 w-16 md:w-20 h-1.5 bg-nss-red rounded-full"></span>
                        </h2>

                        <div className="relative mb-10 pl-8">
                            <Quote className="absolute -top-2 left-0 w-8 h-8 text-nss-blue/20 transform -scale-x-100" />
                            <blockquote className="text-2xl text-gray-700 font-serif italic leading-relaxed relative z-10">
                                "{officer.message || "Empowering the youth to build a stronger nation through selfless service."}"
                            </blockquote>
                        </div>

                        <p className="text-gray-500 text-lg leading-relaxed mb-10 max-w-lg mx-auto md:mx-0">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                            <a
                                href="/mentors"
                                className="inline-flex items-center gap-2 px-8 py-4 bg-nss-navy text-white rounded-lg font-semibold hover:bg-nss-navy-light transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
                            >
                                Meet Our Mentors
